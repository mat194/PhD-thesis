...
External validation will be performed using retrospective clinical datasets containing TDM data for the selected antimicrobial agents. Validation will assess both population-level (a priori) and individualized (a posteriori) predictive performance of the reconstructed models.
